...
<head>
	...
	<title>Редактировать cash flow</title>
						...
						<div class="container-fluid pt-8">
							<div class="page-header mt-0 shadow p-3">
								<ol class="breadcrumb mb-sm-0">
									...
									<li class="breadcrumb-item active" aria-current="page">Редактировать cash flow</li>
								</ol>
							</div>
			      						...
			      						<div class="container">
					        				<div class="row">
							        			<div class="col-md-4 mb-2">
							        				...
							        				<input id="amount" class="form-control" type="number" name="amount" value="{{ $cashflow->amount }}">
							        			</div>
							        			<div class="col-md-4 mb-2">
							        				<?php 
					      						...
					      						<div class="col-md-4 mb-2 category_div">
											        ...
											        <select id="category" class="form-control" name="category_id">
											        	@foreach($categories as $key => $value)
											        		@if ($value->id == $cashflow->category_id)
							        			...
							        			<div class="col-md-12 mb-2">
							        				...
							        				<textarea id="note" class="form-control" rows="10" name="note">{{ $cashflow->note }}</textarea>
							        			</div>
							        			<div class="col-md-12 mb-2">
